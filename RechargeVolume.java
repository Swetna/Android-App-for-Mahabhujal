...
import in.mahabhujal.mahabhujal.databaseHelpers.DatabaseHelperRechargeStructure;

public class RechargeVolume extends AppCompatActivity {
    ...
    private EditText WaterVolume;
    private EditText WaterVolumeUnit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WaterVolume = (EditText) findViewById(R.id.water_volume);
       WaterVolumeUnit = (EditText) findViewById(R.id.unit_water_vol);
